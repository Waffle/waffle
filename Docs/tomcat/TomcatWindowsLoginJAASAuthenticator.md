...
Package Waffle JARs, including `waffle-jna.jar`, `guava-17.0.jar`, `jna-4.1.0.jar`, `jna-platform-4.1.0.jar`, `slf4j*.jar` and `waffle-jaas.jar` in the application's lib directory or copy them to Tomcat's lib.
